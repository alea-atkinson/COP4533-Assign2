...
3. To run the executable, run the following command in the terminal: **./cache k m**. you must provide 2 command line arguments. The first argument k determines the size of the cache, and the second argument m determines the number of requests: ex. ./cache 5 55 runs with a cache of size 5 and 55 requests
